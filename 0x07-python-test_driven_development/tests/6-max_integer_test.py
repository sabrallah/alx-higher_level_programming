...
class TestMaxInteger(unittest.TestCase):
    ...
    def test_positive(self):
        """
            Checks if functions can gives the highest positive
            integer
        """
    ...
    def test_neg_float(self):
        """
            Checks if functions can gives the highest negative
            float
        """
    ...
    def test_char(self):
        """
            Checks if functions can gives the highest string
        """
    ...
    def test_empty_str(self):
        """
            Checks if functions can handles empty string
        """
