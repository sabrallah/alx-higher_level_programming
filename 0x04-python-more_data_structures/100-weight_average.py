...
def weight_average(my_list=[]):
    ...
    if not my_list:
        # return 0
        return 0
    # initialize a variable to store the sum of the products of scores and weights
    sum_product = 0
    ...
    for score, weight in my_list:
        ...
        sum_weight += weight
    # calculate the weighted average by dividing the sum_product by the sum_weight
